...
We tested numerous models as shown above. Based on our best model, model 3, there has been no significant decline in abundance across this ESU since 1970. We found some support for the idea that some populations are significantly correlated. However this support did not align with our initial assumptions that the correlation would be based on previously established MPG's. Insted we found that the Grays and Chinook Rivers were correlated with the Lower Gorge Tributaries in model 7. Since these populations are in different habitat types, Coastal vs. Cascade, and would be expected to covary with other more similar regions we did not see a biological reason to group these tributaries. However, additional information may present a valid rationale for why these groups would be correlated. 
