...
#look at corrplot
Q2 <- coef(m1, type = "matrix")$Q
corrmat2 <- diag(1/sqrt(diag(Q2))) %*% Q2 %*% diag(1/sqrt(diag(Q2)))
corrplot(corrmat2)
...
#look at corrplot
Q3 <- coef(m2.3, type = "matrix")$Q
corrmat3 <- diag(1/sqrt(diag(Q3))) %*% Q3 %*% diag(1/sqrt(diag(Q3)))
corrplot(corrmat3)
...
#look at corrplot
Q4 <- coef(m2.4, type = "matrix")$Q
corrmat4 <- diag(1/sqrt(diag(Q4))) %*% Q4 %*% diag(1/sqrt(diag(Q4)))
corrplot(corrmat4)
...
#################################################################################
#Hypothesis 4.1: Yakima salmon have separate hidden state and Q matrix is unconstrained
...
#Hypothesis 4.4: Yakima salmon have separate hidden state and Q matrix is 
