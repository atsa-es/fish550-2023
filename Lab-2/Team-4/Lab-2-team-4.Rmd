...
Wrangle the data.
We are only interest in the rivers in the Middle Columbia River Unit
...
#knitr::include_graphics(~/FISH550/fish550-2023/Lab-2/Data_Images/"Middle Columbia River sockeye.png")
...
other 3 major population groups maybe more closely linked to each other due to their closer geographic proximity. Thus, we hypothesize that there may be two underlying states. The first desribing just the Yakima group while the second describes the Cascades, John Day, and Walla Walla groups.
