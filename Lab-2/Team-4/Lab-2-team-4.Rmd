...
Hypothesis 2: Four underlying states, each major group. 
    2.1: Q matrix = equal variance covariance (done!)
    2.2: Q matrix = unconstrained (done!)
    2.3: Q matrix = diagonal and equal 
    2.4: Q matrix = custom? 
    
Hypothesis 3: East vs West underlying states. John Day and Cascades vs Walla Walla and Yakima 
...
Hypothesis 4: Two underlying states. Yakama and the rest 
    4.1: Q matrix = equal variance covariance 
    4.2: Q matrix = unconstrained 
    4.3: Q matrix = diagonal and equal  
