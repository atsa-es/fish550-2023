...
Do ARIMA models produce more accurate 5 year forecasts than the Fisheries Research Institute (FRI) for Sockeye in select Bristol Bay Rivers. 
...
names(p.vals) <- names(kp.vals.lev) <- names(kp.vals.tre) <- River
...
```
The Kvichak does not need differencing. The Nushagak and the Wood should be differenced by 1. This level of differencing should remove the upward trend in the Nushagak and Wood Rivers. 
