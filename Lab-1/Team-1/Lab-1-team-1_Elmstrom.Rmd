...
e.train <- window(diff1dat, 1963, 1993)
e.test <- window(diff1dat, 1994, 2020)
...
## Kvichak
kv.datts <- ts(kv$lntotal, start=eg$ret_yr[1])
kv.train <- window(kv.datts, 1963, 1993)
kv.test <- window(kv.datts, 1994, 2020)
