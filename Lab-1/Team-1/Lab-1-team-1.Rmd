...
We divided the rivers among the team members to do the initial exploratory analysis and testing for stationarity. We also tried forecasting for all rivers using the best model sugested by auto.arima.
...
We finally chose three rivers to work with - Kvichak, Wood and Nugashak. We split the data into training data (1963-2015) and testing data (2016-2020). In addition to forecasting with the model suggested by auto.arima, we forecasted for multiple ARIMA models with varying orders to compare the accuracy of the forecasts. We used RMSE to compare the accuracies. We also plotted the FRI forecast to visually compare the model forecast to the FRI forecast. 
