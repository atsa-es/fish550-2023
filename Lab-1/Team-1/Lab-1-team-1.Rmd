...
Kvichak == stationary
Nushagak == non-stationary around a level or stationary around a trend
Wood == non-stationary around a level or stationary around a trend
...
Before this decision, below we check the accuracies for each of the models (n = 9).
...
```
The best model forecast is the one with the lowest RMSE. 
