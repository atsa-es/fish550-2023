...
#check the plot
plot.ts(Wood_1.3.ts, ylab = "log Abundance", main ="Sockeye: 1 yr freshwater, 3 yrs ocean" )
#looks like there is a positive trend to the data: not stationary, or could be stationary around a trend
plot.ts(Wood_2.2.ts, ylab = "log Abundance", main ="Sockeye: 2 yrs freshwater, 2 yrs ocean" )
...
#plots
plot(Kvichak_1.3.ts, ylab = "log Abundance", main = "Sockeye: 1 yr freshwater, 3 yrs ocean" )

plot(Kvichak_2.2.ts, ylab = "log Abundance", main = "Sockeye: 2 yrsfreshwater, 2 yrs ocean" )
