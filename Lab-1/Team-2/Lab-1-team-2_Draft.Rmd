...
Not sure what the text below is about. I'm fine to keep it if it is meaningful though. I think just say we trusted auto.arima() to properly fit the training models. We could potentially compare the models that were fitted to the models that were used in the Check residuals section above.
