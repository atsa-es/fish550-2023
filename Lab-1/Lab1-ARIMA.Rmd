...
1. Bristol Bay Data: Nick Chambers (SAFS), Liz Elmstrom (SAFS), Eric French (Civil), Maria Kuruvilla (QERM)
2. Bristol Bay Data: Lauren French (Marine Affairs), Grace Henry (SAFS), Dylan Hubl (ESRM)
3. Ruggerone & Irvine Data: Miranda Mudge (Molecular & Cell Bio), Zoe Rand (QERM), Madison Shipley (SAFS), Emma Timmins-Schiffman (Genome Sci)
