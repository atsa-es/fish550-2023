...
All three regions do not appear to be stationary, they exhibit random walk characteristics, so will need to be modeled that way.
...
Sockeye salmon in East Asia, Alaska, and the West Coast all appear to have random walk characteristics. Using a random walk style model, or differenced in order to use a Box Jenkins approach. 
