...
Kvichak sockeye recruitment/spawner ratio can be explained well by a simple random walk process. Based on the AICc, the best performing model was the simplest model without any density-dependent or PDO information. Recruitment potential is likely dependent less on biological interactions and more on environmental influences. Environmental factors besides PDO that influence productivity can include ENSO, SST, and sea surface air pressure (Ovando et al. 2022).
