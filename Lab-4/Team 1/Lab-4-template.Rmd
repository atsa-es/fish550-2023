...
# Team contributions
Zoe coded state 2 model.
Eric coded state 3 model.
Dylan created tables, results, and led discussion section for group.
Entire group contributed thoughts and comments to the discussion section.
