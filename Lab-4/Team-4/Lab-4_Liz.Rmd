...
#we will focus on copepod richness, N cop. biomass, S cop. biomass, Biological_transition
#rows 9-11
...
mod.tab
```
Inclusion of SST and Deep Temp seems as covariates for the transition matrix seems to improve the 2-state model. 
...
Adding covariates only slightly changes the fits of states. The transition from state 1 to 2 only differ by 1 year around 1998 and 2006. 

TALK ABOUT COVARIATE EFFECTS HERE. 
...
Temperature covariates seem to be important in explaining the state transitions, which is as expected, since copepods communities are known to depend on temperature. Warmer temperatures generally increase copepod diversity. 
