...
dfa.fit1<-MARSS(plank.t, model=dfa.model1, control=cntl.list, silent = TRUE)
...
dfa.fit2<-MARSS(plank.t, model=model.list, z.score=T, form='dfa', control=cntl.list, silent = TRUE)
...
dfa.fit3<-MARSS(plank.t, model=model.list, z.score=T, form='dfa', control=cntl.list, silent = TRUE)
...
dfa_temp <- MARSS(plank.t, model = mod_list, form = "dfa", z.score = FALSE,
                  control=cntl.list, covariates = temp, silent = TRUE)
dfa_TP <- MARSS(plank.t, model = mod_list, form = "dfa", z.score = FALSE,
                control=cntl.list, covariates = TP, silent = TRUE)
dfa_both <- MARSS(plank.t, model = mod_list, form = "dfa", z.score = FALSE,
                  control=cntl.list, covariates = rbind(temp, TP), silent = TRUE)
...
dfa_TPseas <- MARSS(plank.t, model = mod_list, form = "dfa", z.score = FALSE,
                  control=cntl.list, covariates = rbind(TP, dd), silent = TRUE)

dfa_TPtempseas <- MARSS(plank.t, model = mod_list, form = "dfa", z.score = FALSE,
                    control=cntl.list, covariates = rbind(temp,TP, dd), silent = TRUE)
...
dfa_TPseas.10 <- MARSS(plank.t10, model = mod_list, form = "dfa", z.score = TRUE,
              control=cntl.list, covariates = rbind(TP.z,dd.10), silent = TRUE)
