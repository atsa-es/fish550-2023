...
The Z matrix would look like this (I'M NOT SURE HOW TO PUT IN MATRIX FORM HERE)
...
dfa_TPseas.10 <- MARSS(plank.t10, model = mod_list, form = "dfa", z.score = TRUE,
              control=cntl.list, covariates = rbind(TP.z,dd.10))
...
ETS explored the data to find usable parts for the analysis; she also did the first attempt at fitting a DFA with different trends. MM and KV refined the DFA and added analyses for assessing model fit. They added covariates and seasonal effects to the model. ETS selected the subset of data to analyze and applied the previous code developed by all team members to the new subset of the data. ETS drafted the final lab report. Code was de-bugged and the lab report was finalized by KV and MM?
