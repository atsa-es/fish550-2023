...
basic.mod <- MARSS(plankton_z, model = mod.list.basic, control = cont_list.basic, inits = init_list, form = "dfa",
                    z.score = FALSE) #fails to converge

cont_longer <- list(maxit = 5000, allow.degen = TRUE)
basic.mod <- MARSS(y = plankton_z, model = mod_list, inits = init_list, control = cont_longer) #fails to converge
