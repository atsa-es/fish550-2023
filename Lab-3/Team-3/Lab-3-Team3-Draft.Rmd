...
mod_list = list(m = mm, R = "diagonal and unequal")
## list with model inits
init_list <- list(x0 = matrix(rep(0, mm), mm, 1))
...
Best performing based on AICc is the one with 3 states, but not meaningfully different from the 2 and 4 states. We decided on the simplest possible model of 2 states.
...
## get model fits & CI's
best_model_i = which(mod.tab$AICc==min(mod.tab$AICc,na.rm=T))
